...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/leandro/cuanto-sabe-aws/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/leandro/cuanto-sabe-aws/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'livewire.update','livewire.upload-file','livewire.preview-file','home','guest-dashboard','dashboard','profile.edit',
'profile.update','profile.destroy','questions','users','users.updateRole',
'users.destroy','admin.panel','juego.panel','motivo.store','categoria.store',
'pregunta.store','game-session.start','game-session.end','game.participate','overlay',
'game-session.reveal','game-session.random-question','game-session.overlay-reset','game-session.select-option','game.toggleApuestaX2','game.toggleDescarte','participants.form','participants.add',
'participants.list','salir.juego','queue-list','game-sessions.queue-list','ruleta',
'overlay.lanzar-pregunta','game-session.sync-question','participar','participar.enviar','participar.limpiar','participar.reset','salirDelJuego','questions.import.create',
'questions.import.store','register','login',
...
'auth.confirm-password','auth.forgot-password','auth.login','auth.participants-form','auth.register',
...
'components.nav-link','components.panel-component','components.primary-button','components.puntaje-participante','components.queue-list',
'components.responsive-nav-link','components.secondary-button','components.text-input','components.user-dropdown','dashboard',
'game.scripts','layouts.app','layouts.guest','layouts.navigation','overlay',
'participar','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'questions','ruleta','users','welcome','laravel-exceptions-renderer::components.badge',
...
'BROADCAST_DRIVER','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER',
'PUSHER_PORT','PUSHER_SCHEME','CACHE_STORE','CACHE_DRIVER','MEMCACHED_HOST',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_CLUSTER',
'VITE_PUSHER_HOST','VITE_PUSHER_PORT','VITE_PUSHER_SCHEME',);
